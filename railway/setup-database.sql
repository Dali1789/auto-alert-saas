...
-- Auto-Alert SaaS Database Setup
-- Execute this in Railway PostgreSQL directly
...
CREATE INDEX idx_auto_alert_searches_user_id ON public.auto_alert_searches(user_id);
CREATE INDEX idx_auto_alert_searches_active ON public.auto_alert_searches(active) WHERE active = true;
CREATE INDEX idx_auto_alert_results_search_id ON public.auto_alert_results(search_id);
CREATE INDEX idx_auto_alert_results_found_at ON public.auto_alert_results(found_at DESC);
CREATE INDEX idx_auto_alert_results_mobile_ad_id ON public.auto_alert_results(mobile_ad_id);
CREATE INDEX idx_auto_alert_notifications_user_id ON public.auto_alert_notifications(user_id);
CREATE INDEX idx_auto_alert_notifications_sent_at ON public.auto_alert_notifications(sent_at DESC);
...
-- Insert sample search for BMW 740d
...
SELECT 'auto_alert_user_profiles' as table_name, count(*) as rows FROM public.auto_alert_user_profiles
UNION ALL
SELECT 'auto_alert_searches' as table_name, count(*) as rows FROM public.auto_alert_searches
UNION ALL  
SELECT 'auto_alert_results' as table_name, count(*) as rows FROM public.auto_alert_results
UNION ALL
SELECT 'auto_alert_notifications' as table_name, count(*) as rows FROM public.auto_alert_notifications;
